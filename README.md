...
After it is installed, when you run the [emulator](https://docs.fireflyzero.com/dev/emulator/), it will run the launcher first, and from there you can select the app you want to run from the list of installed ones.
